...
const MANIFEST = {
  ...
  // in stremio-core's is_resource_supported. (Custom content types were tried to drop
  // Stremio's "- Movie" label but caused worse addon-name+type+name triple-labelling.)
  catalogs: [
